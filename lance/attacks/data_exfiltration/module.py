"""LANCE — Data Exfiltration Attack Module · OWASP LLM06"""
...
OWASP_REF = "LLM06"
DESCRIPTION = (
    "Tests whether the model leaks training data, PII, secrets, API keys, "
    "fine-tuning data, or context window content via crafted extraction prompts."
)
